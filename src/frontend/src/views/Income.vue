...
export default defineComponent({
    ...
    methods: {
        async saveAddIncome(entry: Entry) {
            ...
            this.toasts = this.toasts.concat({
                type: 'success',
                title: 'New Income',
                text: 'New income was successfully added',
            })
...
<template>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <font-awesome-icon icon="sack-dollar" /> Income
                        </li>
                    </ol>
                </div>
            </div>
    ...
    <EntryTable :data="tableData" :toasts="toasts" @add:entry="saveAddIncome" />
</template>
